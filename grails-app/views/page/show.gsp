                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: pageInstance, field: "content").replace("\n", "<br />")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="page.dateModified.label" default="Date Modified" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${pageInstance?.dateModified}" /></td>
